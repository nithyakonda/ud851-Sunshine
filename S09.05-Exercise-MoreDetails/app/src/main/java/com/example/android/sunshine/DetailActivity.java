...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(ID_FORECAST_DETAIL_LOADER, null, this);
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if (!cursorHasValidData) {
            ...
            String desc = SunshineWeatherUtils.getStringForWeatherCondition(
                    DetailActivity.this,
            ...
            mHumidity.setText(String.valueOf(data.getDouble(INDEX_WEATHER_HUMIDITY)));
            mWind.setText(String.valueOf(data.getDouble(INDEX_WEATHER_WIND_SPEED)));
            mPressure.setText(String.valueOf(data.getDouble(INDEX_WEATHER_PRESSURE)));

            String highAndLowTemperature =
                    SunshineWeatherUtils.formatHighLows(DetailActivity.this, high, low);

            mForecastSummary = date + " - " + desc + " - " + highAndLowTemperature;
